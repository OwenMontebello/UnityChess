...
public class UIManager : MonoBehaviourSingleton<UIManager>
{
    ...
    private void Start()
    {
        // Subscribe to various single-player game events.
    ...
    /// <summary>
    /// Called when a new game starts (single-player logic).
    ...
    /// <summary>
    /// Called when the game ends (via checkmate or stalemate).
    ...
    /// <summary>
    /// Called when a move is executed (single-player logic).
    ...
    /// <param name="latestTurnSide">The side that executed the move.</param>
    ...
    // Subscribing to Netcode events so we can see when clients connect/disconnect.
    ...
    /// <summary>
    /// Start hosting a new session (Host + Server).
    /// Attach this to a "Host" button.
    /// </summary>
    ...
    /// <summary>
    /// Leave the current session (either host or client).
    /// Attach this to a "Leave" button.
    /// </summary>
    ...
    /// <summary>
    /// Attempt to rejoin the session if disconnected.
    /// Attach this to a "Rejoin" button.
    /// </summary>
